...
anchor1_rtt_array = np.array(anchor1_rtt_list)
anchor1_response_array = np.array(anchor1_response_list)
anchor1_request_array = np.array(anchor1_request_list)

anchor2_rtt_array = np.array(anchor2_rtt_list)
anchor2_response_array = np.array(anchor2_response_list)
anchor2_request_array = np.array(anchor2_request_list)

anchor3_rtt_array = np.array(anchor3_rtt_list)
anchor3_response_array = np.array(anchor3_response_list)
anchor3_request_array = np.array(anchor3_request_list)

np.savez('fingerprint_experiment1/distance10.npz', anchor1_rtt=anchor1_rtt_array, anchor1_response=anchor1_response_array, anchor1_request=anchor1_request_array,
                    anchor2_rtt=anchor2_rtt_array, anchor2_response=anchor2_response_array, anchor2_request=anchor2_request_array,
                    anchor3_rtt=anchor3_rtt_array, anchor3_response=anchor3_response_array, anchor3_request=anchor3_request_array)